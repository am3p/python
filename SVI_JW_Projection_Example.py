...
from SVI_JW_ATMFixed import SVI_S
...
base_date_lvs = [datetime.date(2016, 2, 11), datetime.date(2016, 2, 25), datetime.date(2016, 3, 24)]
...
for m in range(3):
    ...
    for n in range(4):
        ...
        ssvi = SSVI(ivs.strikes, ti, fi, vi, ir, 'Heston')
