...
#      returns initial value of SVI-JW parameter (psi, p)
...
class SSVI(object):
    ...
    # Heston-like formula Jacobian: correct?
    ...
    def SSVI_calib_Heston(self):
        ...
        # initial values of SVI-JW parameter
        init_val = []
        for i in range(len(self._T)):
            ...
            init_val.append(np.array([psi, p]))
        return init_val
